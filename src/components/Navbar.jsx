          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            <div className='d-flex'>
              ...
              <Tooltip followCursor TransitionComponent={Zoom} title="LinkedIn">
                <a href='https://www.linkedin.com/company/openvoicehub/' target='_blank' className="nav-link cursor mx-2" ><i className='fa-brands fa-linkedin'></i></a>
              </Tooltip>
              <Tooltip followCursor TransitionComponent={Zoom} title="Toggle Darkmode">
                <a className="nav-link cursor mx-2" onClick={() => toggleDarkmode()} ><i className={`${darkMode ? 'fa' : 'fa-regular'} fa-moon`}></i></a>
              </Tooltip>
            </div>
